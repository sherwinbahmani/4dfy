...
def load_model_checkpoint(model, ckpt=None, model_info = {"repo_id": "VideoCrafter/VideoCrafter2", "filename": "model.ckpt"}):
    ...
    if not ckpt or ckpt == "VideoCrafter/VideoCrafter2":
        ckpt = hf_hub_download(**model_info)
    print(f"Loading model from cache file: {ckpt}")
